            ...
            <div className="w-full mb-4 flex items-center justify-between">
                ...
                <div className="flex md:hidden gap-x-2 items-center">
                    <button className="rounded-full p-2 bg-white items-center justify-center hover:opacity-75 transition">
                        <HiHome className="text-black" size={27} />
                    </button>
                    <button className="rounded-full p-2 bg-white items-center justify-center hover:opacity-75 transition">
                        <BiSearch className="text-black" size={27} />
                    </button>
                </div>
                <div className="flex justify-between items-center gap-x-4">
                    ...
                    {user? (
                        <div className="flex gap-x-4 items-center">
                            ...
                            <>
                                <div>
                                    <Button onClick={authModal.onOpen} className="bg-trasparent text-neutral-300 font-medium">
                                        Sign-Up
                                    </Button>
                                </div>
                                <div>
